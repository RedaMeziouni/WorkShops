...
--
-- Hôte : 127.0.0.1
-- Généré le : mar. 23 fév. 2021 à 23:21
...
--
CREATE DATABASE IF NOT EXISTS `atelier_2` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `atelier_2`;
...
('root', '[{\"db\":\"atelier2\",\"table\":\"departments\"},{\"db\":\"e-learning\",\"table\":\"utilisateurs\"}]');
...
('root', '2021-02-23 22:19:08', '{\"Console\\/Mode\":\"show\",\"lang\":\"fr\",\"ThemeDefault\":\"original\",\"Console\\/Height\":363.001967}');
